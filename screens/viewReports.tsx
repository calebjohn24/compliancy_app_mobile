...
export default class viewReportsPanel extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            return fetch('https://cd940c5a21e2.ngrok.io/api/view-reports', {
                method: 'POST',
                headers: {
    ...
    renderItem = (item) => {
        const link = 'https://cd940c5a21e2.ngrok.io/' + this.state.compId + '/view-report/'+ item.id + '/' + item.data.token + '/public'
        return (
