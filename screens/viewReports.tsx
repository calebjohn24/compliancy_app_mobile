...
export default class viewReportsPanel extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            return fetch('https://compliancy-app.appspot.com/api/view-reports', {
                method: 'POST',
                headers: {
    ...
    renderItem = (item) => {
        const link = 'https://compliancy-app.appspot.com/' + this.state.compId + '/view-report/'+ item.id + '/' + item.data.token + '/public'
        return (
