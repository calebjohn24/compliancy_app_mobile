...
export default class viewReportsPanel extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        try {
            ...
            return fetch('https://e2efd4cadad6.ngrok.io/api/view-reports', {
                method: 'POST',
                headers: {
    ...
    renderItem = (item) => {
        const link = 'https://e2efd4cadad6.ngrok.io/' + this.state.compId + '/view-report/'+ item.id + '/' + item.data.token + '/public'
        return (
